    ...
    @if ($d->status == 'h')
        <tr>
            ...
            <td>
                ...
                <form action="/presensi/monitoring{{ $d->presensi }}/delete" method="POST" style="margin-left:5px">
                @csrf
                <a class="btn btn-danger btn-sm delete-confirm">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trash-filled" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round"
...
<script>
    $(function() {
        $(".tampilkanpeta").click(function(e) {
            var id = $(this).attr("id"); // atribut menampung atibut dari velue
            $.ajax({
                type: 'POST',
                url: '/tampilkanpeta',
                data: {
                    _token: "{{ csrf_token() }}", // tiap mengirim data harus menggunakan token karena pakek squos
                    id: id
                },
                cache: false,
