                ...
                <tr>
                    ...
                    for($i=1; $i<=$jmlhari; $i++){
                        ...
                        if($r->$tgl != NULL){
                            ...
                            modal-tampilkanpetadiv class="modal modal-blur fade
                            ...
                            if($jam_in != "NA" && $jam_out != "NA"){
                                $total_jam_kerja = hitungjamkerja($tgl_presensi,$jam_mulai,$jam_berakhir,$total_jam,$jam_awal_istirahat, $jam_akhir_istirahat,$terlambat);
                            }else{
                                $total_jam_kerja = 0;
                            }
