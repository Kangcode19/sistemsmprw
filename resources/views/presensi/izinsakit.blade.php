                            ...
                            <div class="col-6">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="{{ Request('dari') }}" id="dari" class="form-control"
                                        placeholder="Izin dari" name="dari">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="{{ Request('sampai') }}" id="sampai"
                                        class="form-control" placeholder="Izin sampai" name="sampai">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-2">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="{{ Request('nik') }}" id="nik" maxlength="15" class="form-control"
                                        placeholder="Username" name="nik">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="{{ Request('nama_lengkap') }}" id="nama_lengkap" maxlength="15"
                                        class="form-control" placeholder="Nama pegawai" name="nama_lengkap">
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Status penerimaan</h5>
