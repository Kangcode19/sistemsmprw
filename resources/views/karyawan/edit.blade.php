    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $karyawan->nik }}" id="nik" maxlength="15" class="form-control" placeholder="Username"
                    name="nik_baru">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="nama_lengkap" maxlength="15" value="{{ $karyawan->nama_lengkap }}" class="form-control"
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="jabatan" maxlength="15" value="{{ $karyawan->jabatan }}" class="form-control"
                    name="jabatan" placeholder="Guru mapel">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="no_hp" maxlength="12" value="{{ $karyawan->no_hp }}" class="form-control" name="no_hp"
                    placeholder="No. HP">
            </div>
        </div>
    </div>
