                                                ...
                                                <div class="col-3">
                                                    <div class="form-group">
                                                        <select name="kode_dept" id="kode_dept" class="form-select">
                                                            <option value="">Kategori pendidik</option>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" id="nik" maxlength="15" class="form-control" placeholder="Username" name="nik">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" id="nama_lengkap" maxlength="15" value="" class="form-control" name="nama_lengkap" placeholder="Nama Lengkap">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" id="jabatan" maxlength="15" value="" class="form-control" name="jabatan" placeholder="kategori pendidik">
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
@push('myscript')
    <script>
        $(function() {
            //masking input untuk nik dan no hp 
            //$("#nik").mask("000000000");
            ...
            $("#frmKaryawan").submit(function() {
                ...
                if (nik == "") {
                    ...
                    Swal.fire({
                        title: 'Warning!',
                        text: 'Kategori pendidik Harus Diisi !',
                        icon: 'warning',
                        confirmButtonText: 'Ok'
                    }).then((result) => {
                        $("#kode_dept").focus();
                    ...
                    Swal.fire({
                        title: 'Warning!',
                        text: 'Data lokasi sekolah Harus Diisi !',
                        icon: 'warning',
                        confirmButtonText: 'Ok'
                    }).then((result) => {
                        $("#kode_cabang").focus();
