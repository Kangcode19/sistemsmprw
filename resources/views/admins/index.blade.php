                                            ...
                                            <div class="col-10">
                                                <div class="form-group">
                                                    <input type="text" name="name" id="name" class="form-control"
                                                        placeholder="Nama admin" value="{{ Request('name') }}">
                                                </div>
                                            </div>
                                            <div class="col-2">
                                                <div class="form-group">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <form action="/konfigurasi/admins/{{ $d->id }}/delete"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/konfigurasi/admins/store" method="POST" id="frmUser">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon">
                                    ...
                                    <input type="text" id="nama_user" value="" class="form-control"
                                        name="nama_user" placeholder="Nama admin">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-1">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <select name="kode_dept" id="kode_dept" class="form-select">
                                        <option value="">Pilih kategori pendidik</option>
    ...
    <script>
        $(function() {
            ...
            $("#frmUser").submit(function() {
                ...
                var role = $("#role").val();
                var kode_cabang = $("#kode_lokasi").val();
                if (nama_user == "") {
                    Swal.fire({
                        title: 'Peringatan!',
                    ...
                    Swal.fire({
                        title: 'Peringatan!',
                        text: 'Peran harus di isi Harus Diisi !',
                        icon: 'warning',
                        confirmButtonText: 'Ok'
                    }).then((result) => {
                        $("#role").focus();
                    ...
                    Swal.fire({
                        title: 'Peringatan!',
                        text: 'Lokasi sekolah Harus di pilih !',
                        icon: 'warning',
                        confirmButtonText: 'Ok'
                    }).then((result) => {
                        $("#kode_cabang").focus();
