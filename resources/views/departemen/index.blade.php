                                            ...
                                            <div class="col-10">
                                                <div class="form-group">
                                                    <input type="text" name="nama_dept" id="nama_dept"
                                                        class="form-control" placeholder="Cari data jabatan"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" id="nik" maxlength="3"
                                    class="form-control" placeholder="Kode Jabatan" name="kode_dept">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" id="nama_dept" maxlength="15" value="" class="form-control" name="nama_dept" placeholder="Nama Jabatan">
                                </div>
                            </div>
                        </div>
        ...
        $(function() {
            ...
            $("#frmKaryawan").submit(function() {
                ...
                if (nik == "") {
                    ...
                    Swal.fire({
                        title: 'Peringatan!',
                        text: 'Keterangan mata pelajaran  !',
                        icon: 'warning',
                        confirmButtonText: 'Ok'
                    }).then((result) => {
                        $("#jabatan").focus();
