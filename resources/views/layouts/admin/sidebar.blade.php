<aside class="navbar navbar-vertical navbar-expand-lg navbar-dark">
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark">
            <a href=".">
                <img src="{{ asset('tabler/static/website.png') }}" width="110" height="32" alt="Tabler"
        ...
        <div class="navbar-nav flex-row d-lg-none">
            ...
            <div class="d-none d-lg-flex">
                <a href="?theme=dark" class="nav-link px-0 hide-theme-dark" title="aktifkan cahaya gelap"
                ...
                <a href="?theme=light" class="nav-link px-0 hide-theme-light" title="aktifkan cahaya terang"
                    data-bs-toggle="tooltip" data-bs-placement="bottom">
                            ...
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    ...
                                    <a class="dropdown-item  {{ request()->is(['konfigurasi/jamkerja']) ? 'active' : '' }}"
                                        ...
                                        Konfigurasi jam kerja pegawai
                                    </a>
                                    <a class="dropdown-item  {{ request()->is(['konfigurasi/jamkerjadept']) ? 'active' : '' }}"
                                        href="/konfigurasi/jamkerjadept">
                                        Konfigurasi jam kerja admin
                                    </a>
                                    <a class="dropdown-item  {{ request()->is(['konfigurasi/lokasi']) ? 'active' : '' }}"
                                        href="/konfigurasi/lokasi">
                                        Konfigurasi jam kerja on atau off
                                    </a>
                                    <a class="dropdown-item  {{ request()->is(['konfigurasi/admins']) ? 'active' : '' }}"
                                        href="/konfigurasi/admins">
