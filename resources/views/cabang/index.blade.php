                                    ...
                                    <div class="row">
                                        <div class="col-10">
                                            <select name="kode_cabang" class="form-select" id="">
                                                <option value="">Data lokasi sekolah</option>
                                            </select>
                                        </div>
                                        <div class="col-2">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="" id="kode_cabang" maxlength="3"
                                class="form-control" placeholder="Kode Lokasi" name="kode_cabang">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" id="nama_cabang" maxlength="10" value="" class="form-control" name="nama_cabang" placeholder="Nama Lokasi">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" id="lokasi_cabang" value="" class="form-control" name="lokasi_cabang" placeholder="Koordinat lokasi">
                            </div>
                        </div>
                    </div>
                    <div class="row">
